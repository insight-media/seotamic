...
return [
    'seotamic_title' => 'SEO',
    'seotamic_description' => 'Control your SEO general settings here. Make sure to read the instructions on each input. This settings can be overidden on specific entries/pages.',
    ...
    'social_image' => 'Image',
    'social_image_instructions' => 'Use your logo or any other branded image for the rest of your pages. Use images with a 1.91:1 ratio and minimum recommended dimensions of 1200x630 for optimal clarity across all devices. The image will be resized to 1200 width.',

    'social_og' => 'Open Graph',
    'social_og_instructions' => 'Open Graph meta tags are snippets of code that control how URLs are displayed when shared on social media.',

    'social_og_display' => 'Display Open Graph tags',

    'social_site_name' => 'Site name',

    'social_og_title_instructions' => 'Keep it short to prevent overflow. 40 characters for mobile and 60 for desktop is roughly the sweet spot. Use the raw title. Don’t include branding (e.g., your site name).',

    'social_og_description_instructions' => 'General Description, can be overridden on specific pages. Complement the title to make the snippet as appealing and click-worthy as possible. Copy your meta description here if it makes sense. Keep it short and sweet. Facebook recommends 2–4 sentences, but that often truncates.',

    'social_twitter_display' => 'Display Twitter tags'
